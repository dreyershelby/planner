 ...
 * axis of the page) sets of 3 holes (for hole-punching) to each page in a
 * spread. in this case, this spread is the active/selected spread.
 *
 * depends on:
 *   function in page/holes.jsx
 *     add_to(pg, on_doc)
 *   doc/layers.jsx
 *   doc/colors.jsx
 */
...
var spread = app.layoutWindows.item(0).activeSpread; // to place the holes

for (var pg_index = 0; pg_index < spread.pages.length; pg_index++)
  add_to(spread.pages.item(pg_index), doc);
